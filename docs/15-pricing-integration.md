...
3. اگر سابقه‌ی buyPrice قبلی وجود نداشته باشد:
   sellPrice = خرید جدید × ۱.۳ (گرد رو به پایین به مضرب ۱۰٬۰۰۰) و پرچم needsReview فعال می‌شود؛
   این موارد در صفحه‌ی قیمت‌ها برای ادمین با هشدار نمایش داده می‌شوند و با ویرایش دستی
   قیمت فروش، پرچم پاک می‌شود
